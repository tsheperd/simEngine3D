...
% Read the input deck
simulation.ReadInputDeck("freeParticleINPUT.mdl");
...
title("Free Particle: O Global Position");
xlabel("t (s)");
ylabel("position (m)");
legend('x','y','z');
hold off;
...
title("Free Particle: O Global Velocity");
xlabel("t (s)");
ylabel("velocity (m/s)");
legend('x','y','z');
hold off;
...
title("Free Particle: O Global Acceleration");
xlabel("t (s)");
ylabel("acceleration (m/s^2)");
legend('x','y','z');
hold off;
if SAVE_PLOTS
	saveas(gcf,'freeParticle_O_Plot.png');
end
...
title("Free Particle: Quaternian Components");
xlabel("t (s)");
ylabel("Quaternian (-)");
legend('1','2','3','4');
ylim([-1,2]);
hold off;
if SAVE_PLOTS
	saveas(gcf,'freeParticle_Quaternian_Plot.png');
end
...
title("Free Particle: O Global Position (Analytical)");
xlabel("t (s)");
ylabel("position (m)");
legend('x','y','z');
hold off;
...
title("Free Particle: O Global Velocity (Analytical)");
xlabel("t (s)");
ylabel("velocity (m/s)");
legend('x','y','z');
hold off;
...
title("Free Particle: O Global Acceleration (Analytical)");
xlabel("t (s)");
ylabel("acceleration (m/s^2)");
legend('x','y','z');
hold off;
